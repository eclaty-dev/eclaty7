...
fr: {
  ...
  ap2_tag:"Notre vision", ap2_h:"Une vision moderne de la beauté et du bien-être",
...
en: {
  ...
  ap2_tag:"Our vision", ap2_h:"A modern vision of beauty and wellness",
...
es: {
  ...
  ap2_tag:"Nuestra visión", ap2_h:"Una visión moderna de la belleza y el bienestar",
      ...
      es: {
        ...
        sections: [
          ...
          {h:"La técnica correcta, paso a paso", ul:[
           ...
           p2:["Tres reglas de oro se repiten sistemáticamente entre los profesionales: una higiene impecable de la herramienta (limpieza tras cada uso para evitar la proliferación bacteriana), un ángulo plano en lugar de perpendicular, y sobre todo suavidad — la presión ligera es más que suficiente."], img:"massage_facial_illus2.jpg", imgAlt:"Demostración del ángulo correcto del gua sha en el rostro"},
...
function buildContact(el){
  ...
  document.getElementById('ct-form').addEventListener('submit', function(e){
    ...
    data.lang = CL;
    data._replyto = 'numery777@gmail.com';
