...
function buildAccueil(el){
  ...
  var trustHtml = '';
  var trustImgs = ['trust_selection.png','trust_partenaires.png','trust_transparence.png','trust_infos.png','trust_cout.png','trust_contenu.jpeg'];
  for(var i=0;i<6;i++){
  ...
  var blogHtml = '';
  for(var i=0;i<3;i++){
    blogHtml += '<div class="blog-card"><div class="blog-img" style="background-image:url(img/blog_eclaty7.jpg);background-size:cover;background-position:center"></div><div class="blog-body"><span class="blog-cat">' + t.cats[i] + '</span><h3>' + t.blog_soon + '</h3></div></div>';
  }
...
function buildProduits(el){
  var t = T[CL];
  el.innerHTML =
  '<div class="phero"><div class="phero-bg" style="background-image:url(img/hero_accueil.jpeg)"></div><div class="phero-ov"></div>' +
...
function buildBlog(el){
  ...
  for(var i=0;i<t.cats.length;i++){
    blogHtml += '<div class="blog-card"><div class="blog-img" style="background-image:url(img/blog_eclaty7.jpg);background-size:cover;background-position:center"></div><div class="blog-body"><span class="blog-cat">' + t.cats[i] + '</span><h3>' + t.bl_soon + '</h3></div></div>';
  }
...
function buildContact(el){
  ...
  '<section><div class="wrap contact-wrap">' +
    ...
    '<div class="contact-icons">' +
      '<a href="mailto:eclaty@zohomail.com" class="c-icon" title="Email" aria-label="Email">✉️</a>' +
      '<a href="https://wa.me/237676852524" target="_blank" rel="noopener" class="c-icon" title="WhatsApp" aria-label="WhatsApp">💬</a>' +
      '<a href="https://www.pinterest.com/eclaty7/" target="_blank" rel="noopener" class="c-icon" title="Pinterest" aria-label="Pinterest">📌</a>' +
    '</div>' +
